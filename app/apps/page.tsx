...
const apps = [
  ...
  },
  {
    ...
    features: [
      "823 curated high-quality riddles",
      "Daily challenge — Wordle-style, with streaks",
      "AI answer checking — type or speak your answer",
      "Lateral thinking, logic, Sherlock-level brain teasers",
      "Deep links to share individual riddles",
      "Favourites, stats, and difficulty filters",
    ],
  },
  {
    id: "ctt",
